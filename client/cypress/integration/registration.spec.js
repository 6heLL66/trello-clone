...
describe('Sign Up Errors', () => {
  ...
  it('Check Username Errors', () => {
    ...
    cy.get('input[name="username"]').type('123').should('have.value', '123')
  ...
  it('Check Password Errors', () => {
    ...
    cy.get('input[name="rpassword"]').type('6').should('have.value', '123456')

    cy.get('input[name="password"]').type('7').should('have.value', '123457')
